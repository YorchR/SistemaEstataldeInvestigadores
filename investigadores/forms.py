...
class FormInvestigador(forms.ModelForm):
    ...
    class Meta:
        model = Investigador
        exclude = ['latitud', 'longitud', 'aprobado', 'es_sei', 'constancia', 'mensajes_no_leidos']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["telefono"].widget.attrs['placeholder'] = (
            'Ingresa tu telefono de contacto para futuras colaboraciones')
...
class FormInvestigadorUpdate(forms.ModelForm):
    ...
    class Meta:
        model = Investigador
        exclude = ['latitud', 'longitud', 'user', 'aprobado', 'constancia', 'mensajes_no_leidos']
...
class FormInvestigadorBase(forms.ModelForm):
    ...
    class Meta:
        model = Investigador
        exclude = ['latitud', 'longitud', 'user', 'aprobado', 'es_sei', 'constancia', 'mensajes_no_leidos']
...
class FormInvestigadorBaseUpdate(forms.ModelForm):
    ...
    class Meta:
        model = Investigador
        exclude = ['latitud', 'longitud', 'user', 'aprobado', 'es_sei', 'constancia', 'curp', 'mensajes_no_leidos']
