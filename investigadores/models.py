...
from usuarios.models import User, Municipio, NIVELSNI, MUNICIPIOS
...
class Investigador(models.Model):
    ...
    # mensajes_no_leidos = models.IntegerField(default = 0)
    ...
    telefono = models.CharField(
        'Telefono de contacto para futuras colaboraciones', max_length=10, blank=True, null=True)
    ...
    nivel = models.ForeignKey(NivelInvestigador, 
                              on_delete=models.DO_NOTHING, default = 0)
    area_conocimiento = models.ForeignKey(AreaConocimiento, on_delete=models.DO_NOTHING, null=True)
