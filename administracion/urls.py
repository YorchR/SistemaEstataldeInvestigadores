...
urlpatterns = [
    ...
    path(
      ...
      path(
          'usuarios/enviar_mensaje/<int:pk>/',
          views.EnviarMensaje.as_view(),
          name='enviar_mensaje_usuario'),
    ...
    # Investigadores
      ...
      path(
          'investigadores/detalles/<int:pk>',
          views.InvestigadorDetalles.as_view(),
          name='investigadores_detalles'),
      path(
          'investigadores/enviar_mensaje/<int:pk>/',
          views.EnviarMensaje.as_view(),
          name='enviar_mensaje_investigador'),
    ...
    path(
      ...
      path(
          'empresas/detalles/<int:pk>',
          views.EmpresaDetalles.as_view(),
          name='empresa_detalles'),
      path(
          'empresas/enviar_mensaje/<int:pk>/',
          views.EnviarMensaje.as_view(),
          name='enviar_mensaje_empresa'),
    ...
    path(
      ...
      path(
          'instituciones_educativas/detalles/<int:pk>',
          views.InstitucionEducativaDetalles.as_view(),
          name='institucion_detalles'),
      path(
          'instituciones_educativas/enviar_mensaje/<int:pk>/',
          views.EnviarMensaje.as_view(),
          name='enviar_mensaje_institucion'),
